...
| GET    | `/auth/me`                                                         | Verify the current teacher credentials                              |
...
Teacher credentials are stored in `teachers.json` for this exercise. The default local
credentials are `teacher` / `mergington`; replace them before deploying outside local
development.
